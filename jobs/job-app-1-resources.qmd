...
**Finding Your Job Ad:** Search for a real job posting relevant to your career goals and submit it along with your application materials on Canvas. Any job reasonably related to your career is acceptable. As a rule of thumb: if your chosen job requires little to no data analysis, statistical modeling, or machine learning, it is likely too far from the course learning objectives — when in doubt, ask Dr. Friedlander.
...
**If your job is too far from the course learning objectives:** Your application materials must still reflect the technical skills covered in this course. If Dr. Friedlander determines that your chosen ad doesn't align closely enough with the course content, your sample analysis should reflect a position with the following profile:
...
-   Proficiency in data manipulation and visualization using R.
-   Expertise in statistical inference and basic statistical models.
-   Familiarity with machine learning techniques including regression and classification, pre-processing and feature engineering, model building, and model evaluation.
...
-   Experience with SQL, R, and/or Excel for data analysis.
...
-   [ ] Job advertisement submitted as a PDF on Canvas
-   [ ] Resume saved and submitted as a PDF (≤ 1 page)
-   [ ] Cover letter saved and submitted as a PDF
-   [ ] Sample analysis is published on a GitHub Pages website
-   [ ] `EricFriedlander` is added as a collaborator on your GitHub repository
-   [ ] GitHub Pages site URL submitted on Canvas
-   [ ] GitHub repository URL submitted on Canvas
-   [ ] All materials are tailored to your chosen job ad
-   [ ] All materials are free of typos and grammatical errors