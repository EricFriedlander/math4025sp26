...
A - Familiarity with concepts from statistical inference, linear regression, and logistic regression. A solid grounding in Python, including `pandas` and `matplotlib`/`seaborn`.

## Course FAQ

**Q - Will we be doing computing?**

A - Yes. We will use the computing language Python for analysis, Quarto for writing up results, and GitHub for version control and collaboration
...
![](images/01/rstudio.png){fig-alt="VS Code logo" fig-align="center" width="5.61in" height="1.6in"}
:::

::: {.fragment fragment-index="2"}
-   All analyses using Python, a general purpose programming language

-   Write reproducible reports in Quarto

-   Access VS Code through your personal computer (preferred) or the college JupyterHub (if available)
:::
:::
...
-   All work in [MATH 4025 course classroom](https://github.com/)
:::
:::
:::
...
-   [Dedicated homework help session](/course-info/syllabus.qmd#class-meetings-office-hours)
