...
-   Missing data is not necessarily the same as have a missing value... You could have observations which are not in your data set which create bias in your sample (Garbage in, Garbage out)
