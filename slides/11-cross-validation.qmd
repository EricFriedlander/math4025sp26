...
We can visualize the distribution of $R^2$ scores across the 10 folds:
...
p = (ggplot(r2_df, aes(x='Model', y='R-squared', fill='Model'))
...
- **Variants**: `RepeatedKFold` for more robust estimates, `StratifiedKFold` for imbalanced classification.
