...
In your Jupyter notebook, create a code cell at the top and load `pandas`, `seaborn`, `matplotlib.pyplot`, . Then use the following line of code to load the `tips` dataset from the `seaborn` package `tips = sns.load_dataset("tips")`.
