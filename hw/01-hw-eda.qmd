...
# --- Plot 1: Boxplot ---
(
    p9.ggplot(tips, aes(x='Weekday', y='Tip'))
    + p9.geom_boxplot()
    + p9.labs(title="Tips by Day of the Week", x="Day of the Week", y="Tips")
)

# --- Plot 2: BoxpFlot + Jitter ---
(
    p9.ggplot(tips, aes(x='Weekday', y='Tip'))
    + p9.geom_boxplot(outlier_shape=None) # Hide outliers so they aren't plotted twice
