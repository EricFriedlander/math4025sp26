...
::: {.callout-tip title="Question"}
Use `StandardScaler` to center and scale your data sets using the mean and standard deviation from your training set.
:::

## Exercise 6

::: {.callout-tip title="Question"}
Create a `Pipeline` to fit a `KNeighborsClassifier` model that uses `weights="uniform"` with 1 neighbor that includes the scaler above and fit the model to your training set.
:::
